...
def scrabble(word):
    ...
    for word_i in word_lst:
        if word_i in one_p:
            points += 1
        elif word_i in two_p:
            points += 2
        elif word_i in three_p:
            points += 3
        elif word_i in four_p:
            points += 4
        elif word_i in five_p:
            points += 5
        elif word_i in eight_p:
            points += 8
        elif word_i in ten_p:
            points += 10
        else:
            points += 15
    print(f'{word} --> {points}')
